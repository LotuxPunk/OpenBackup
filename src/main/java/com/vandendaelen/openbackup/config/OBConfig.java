...
import com.vandendaelen.openbackup.utils.EnumFormat;
...
public class OBConfig {
    ...
    public static class Properties{
        ...
        @Config.LangKey("config.prop.format")
        @Config.Comment("Format to use to compress backups")
        public EnumFormat format = EnumFormat.ZIP;
    }
}
